...
import { MoveFolderModalContent } from './index'
...
describe('MoveFolderModalContent', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  })

  it('renders the count-based title for a single record', () => {
    render(<MoveFolderModalContent records={[buildLoginRecord()]} />)
  ...
  it('shows the error alert when the vault API throws', async () => {
    ...
    render(
      <MoveFolderModalContent records={[buildLoginRecord({ folder: null })]} />
    )
